...
def run(protocol: protocol_api.ProtocolContext):   
     ...
     ######################################################
     precursors_vol20000_pos7 = protocol.load_labware("lamaiufrgscinza_12_tuberack_20000ul", location='7')

     precursors_vol15000_pos4 = protocol.load_labware("lamaiufrgsbranco_re_12_tuberack_15000ul", location='4')

     final_vol5000_pos3 = protocol.load_labware("lamaiufrgspreto24_re_24_tuberack_5000ul", location='3')

     final_vol5000_pos6 = protocol.load_labware("lamaiufrgspreto24_re_24_tuberack_5000ul", location='6')

     intermediate_vol15000_pos2 = protocol.load_labware("lamaiufrgsbranco_re_12_tuberack_15000ul", location='2')

     intermediate_vol15000_pos5 = protocol.load_labware("lamaiufrgsbranco_re_12_tuberack_15000ul", location='5')

     final_vol20000_pos9 = protocol.load_labware("lamaiufrgscinza_12_tuberack_20000ul", location='9')

     precursors_vol20000_pos1 = protocol.load_labware("lamaiufrgsreservatoriotemp_1_reservoir_80000ul", location='1')
     ######################################################
     ...
     ######################################################
     solution_nicknames = {
         "precursor_solution_1": "precursor1",
         "precursor_solution_2": "precursor2",
     ...
     initial_solutions = {
         "precursor_solution_1": [
           {"container": precursors_vol20000_pos7, "positions": ['A1', 'A2'], "volume": 10000},
         ],
         "precursor_solution_2": [
           {"container": precursors_vol20000_pos7, "positions": ['A3', 'A4'], "volume": 10000},
         ],
         "ligand_1": [
           {"container": precursors_vol15000_pos4, "positions": ['A1'], "volume": 5000},
         ],
         "ligand_2": [
           {"container": precursors_vol15000_pos4, "positions": ['A2'], "volume": 5000},
         ],
         "antisolvent": [
           {"container": precursors_vol20000_pos1, "positions": ['A1'], "volume": 80000},
         ],
     }
     ######################################################
     ...
     intermediate_solutions = [
         {"container": "intermediate_vol15000_pos5", "positions": ['A1'], "solutions": {
             "precursor_solution_1": 1000,
             "precursor_solution_2": 1000,
             "ligand_1": 100,
         }},
         {"container": "intermediate_vol15000_pos5", "positions": ['A2'], "solutions": {
             "precursor_solution_1": 1000,
             "precursor_solution_2": 1000,
             "ligand_1": 200,
         }},
         {"container": "intermediate_vol15000_pos5", "positions": ['A3'], "solutions": {
             "precursor_solution_1": 1000,
             "precursor_solution_2": 1000,
             "ligand_1": 300,
         }},
         {"container": "intermediate_vol15000_pos5", "positions": ['A4'], "solutions": {
             "precursor_solution_1": 1000,
             "precursor_solution_2": 1000,
             "ligand_1": 400,
         }},
         {"container": "intermediate_vol15000_pos5", "positions": ['B1'], "solutions": {
             "precursor_solution_1": 1000,
             "precursor_solution_2": 1000,
             "ligand_1": 500,
         }},
         {"container": "intermediate_vol15000_pos5", "positions": ['B2'], "solutions": {
             "precursor_solution_1": 1000,
             "precursor_solution_2": 1000,
             "ligand_1": 600,
         }},
         {"container": "intermediate_vol15000_pos5", "positions": ['B3'], "solutions": {
             "precursor_solution_1": 1000,
             "precursor_solution_2": 1000,
             "ligand_1": 700,
         }},
     ...
     ######################################################
     final_solutions = [
         {"container": "final_vol20000_pos9", "positions": ['A1'], "solutions": {
             "antisolvent": 10000,
             "intermediate_solution": 
                 {"container": "intermediate_vol15000_pos5", "well": "A1", "volume": 300}
         }},
         {"container": "final_vol20000_pos9", "positions": ['A2'], "solutions": {
             "antisolvent": 10000,
             "intermediate_solution": 
                 {"container": "intermediate_vol15000_pos5", "well": "A1", "volume": 300}
         }},
         {"container": "final_vol5000_pos6", "positions": ['A1'], "solutions": {
             "antisolvent": 3000,
             "ligand_1": 600,
             "intermediate_solution": 
                 {"container": "intermediate_vol15000_pos5", "well": "A2", "volume": 300}
         }},
         {"container": "final_vol5000_pos6", "positions": ['A2'], "solutions": {
             "antisolvent": 3000,
             "ligand_1": 600,
             "intermediate_solution": 
                 {"container": "intermediate_vol15000_pos5", "well": "A2", "volume": 300}
         }},
         {"container": "final_vol5000_pos6", "positions": ['A3'], "solutions": {
             "antisolvent": 3000,
             "ligand_1": 600,
             "intermediate_solution": 
                 {"container": "intermediate_vol15000_pos5", "well": "A3", "volume": 300}
         }},
         {"container": "final_vol5000_pos6", "positions": ['A4'], "solutions": {
             "antisolvent": 3000,
             "ligand_1": 600,
             "intermediate_solution": 
                 {"container": "intermediate_vol15000_pos5", "well": "A3", "volume": 300}
         }},
         {"container": "final_vol5000_pos6", "positions": ['A5'], "solutions": {
             "antisolvent": 3000,
             "ligand_1": 600,
         }},
     ]
